...
%
% $Id: definitions.tex 768 2010-05-15 20:26:07Z dcf21 $
%
...
%\setlength{\dontdowidth}{10cm}
\newenvironment{dontdo}{\vspace{3mm}\noindent\begin{tabular}{p{1cm}p{10cm}}\noindent\includegraphics[width=0.9cm]{cross.eps}&\noindent\begin{minipage}{10cm}\tt}{\end{minipage}\end{tabular}\vspace{3mm}}
\newenvironment{dodo}  {\vspace{3mm}\noindent\begin{tabular}{p{1cm}p{10cm}}\noindent\includegraphics[width=0.9cm]{tick.eps} &\noindent\begin{minipage}{10cm}\tt}{\end{minipage}\end{tabular}\vspace{3mm}}
