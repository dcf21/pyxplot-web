...
\rhead{\thepage}
\lfoot{}\rfoot{}
\cfoot{\bf\footnotesize\copyright\ 2010 Dominic Ford. Distributed under the GNU General Public License, version 2. Document downloaded from \url{http://dcford.org.uk/astrolabe/index.html}}
...
\input{tmp/lat}\footnote{Alternative versions of this document prepared for
...
\begin{figure}
\centerline{\includegraphics{../astrolabe_parts/mother_back}}
