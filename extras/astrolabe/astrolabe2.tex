...
\rhead{\thepage}
\lfoot{}\rfoot{}
\cfoot{\bf\footnotesize\copyright\ 2010 Dominic Ford \& Katie Birkwood. Permission is granted to make unlimited copies for educational or personal use only. Not for commercial use or resale.}

\fancypagestyle{plain}{%
\fancyhf{} % clear all header and footer fields
\fancyfoot[C]{\bf\footnotesize\copyright\ 2010 Dominic Ford \& Katie Birkwood. Permission is granted to make unlimited copies for educational or personal use only. Not for commercial use or resale.}
...
\section*{Mother: Back}
\label{mother_back}
\vspace{-1cm}\centerline{\includegraphics{output/mother_back.eps}}
\section*{Mother: Front}
\label{mother_front}
\vspace{-1cm}\centerline{\includegraphics{output/mother_front.eps}}
\section*{The Plate}
\label{plate}
\vspace{1.5cm}\centerline{\includegraphics{output/plate.eps}}
\section*{The Rete}
\label{rete}
