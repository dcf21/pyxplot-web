...
\title{\vspace{-3cm}Flatpack Astrolabe Kit, Mk II}
...
\section*{Mother: Back}
\label{mother_back}
\vspace{-1cm}\centerline{\includegraphics{tmp/mother_back.eps}}
\section*{Mother: Front}
\label{mother_front}
\vspace{-1cm}\centerline{\includegraphics{tmp/mother_front.eps}}
\section*{The Rete}
\label{rete}
\vspace{1.5cm}\centerline{\includegraphics{tmp/rete.eps}}
\section*{The Label and Rule}
\label{rule}
\centerline{\includegraphics{tmp/rule.eps}}
\end{document}
